...
class RoktAuthenticator(OAuthAuthenticator, metaclass=SingletonMeta):
    """Authenticator class for Rokt."""
    ...
    @classmethod
    def create_for_stream(cls, stream) -> RoktAuthenticator:  # noqa: ANN001
